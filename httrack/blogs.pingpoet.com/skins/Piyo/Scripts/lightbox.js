...
function showLightbox(objLink)
{
	...
	//To work around IE wrong managing of urls in filters
	objOverlay.style.filter='progid:DXImageTransform.Microsoft.AlphaImageLoader(src="'+overlayImage+'", sizingMethod="scale")';
